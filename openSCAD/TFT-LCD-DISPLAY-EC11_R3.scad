...
//
//  This is a box for TFT-LCD-DISPLAY-EC11 Rev. 3.n
//
//  Version 1.0.0 (15-06-2026)
//
...
[
 ...
 ,["PCM5102MK2",   48,       48.5, (pcbWidth+10)*-1, -20,          1.6
                          , standoffHeight, standoffDiameter, standoffPinDiameter, standoffHoleSlack]
];
...
pcbStands = 
[//0, 1,           -2-,                                                             3, 4, 5,     6,     7, 8    
  [3, 3.2, (baseWallHeight+lidWallHeight)-(basePlaneThickness+lidPlaneThickness)-4, 3, default, 1+0.4, 2+0.4, 1, 7
          , yappLidOnly, yappHole, yappAllCorners
          , yappCoordPCB
          , [yappPCBName, "Main"]
  ]
// 0, 1,             -2-,                                                         3, 4, 5,     6,     7, 8  
 ,[3, 3, (baseWallHeight+lidWallHeight)-(basePlaneThickness+lidPlaneThickness)-4, 3, default, 1+0.4, 2+0.4, 1, 7
          , yappLidOnly, yappHole, yappAllCorners
          , yappCoordPCB
          , [yappPCBName, "PCM5102MK2"]
  ]
...
[
 ...
 ,[78.3,              pcbWidth-13, 14.2, 13.2, 1, yappRoundedRect, yappCenter]  //-- Rotary Encoder
 ,[78.3,              pcbWidth-31, 13,   13,   4, yappCircle, yappCenter]       //-- Key0
// 3,                    3.2.   ----
 ,[3,                    3.2, 1.5, 1.5, 1.5, yappCircle, yappCenter] //-- Screw hole Top right
 ,[3,           pcbWidth-3.2, 1.5, 1.5, 1.5, yappCircle, yappCenter] //-- Screw hole Bottom right
 ,[pcbLength-3,          3.2, 1.5, 1.5, 1.5, yappCircle, yappCenter] //-- Screw hole Top left
 ,[pcbLength-3, pcbWidth-3.2, 1.5, 1.5, 1.5, yappCircle, yappCenter] //-- Screw hole Top left
// PCM5102MK2 -- 3, 3 --
 ,[3,                         3, 1.5, 1.5, 1.5                                //-- Screw hole Top right
                      , yappCircle, yappCenter, [yappPCBName, "PCM5102MK2"]]  //-- Screw hole Top right
 ,[3, pcbLength("PCM5102MK2")-3, 1.5, 1.5, 1.5                                //-- Screw hole Bottom right
                      , yappCircle, yappCenter, [yappPCBName, "PCM5102MK2"]]  //-- Screw hole Bottom right
 ,[pcbWidth("PCM5102MK2")-3,  3, 1.5, 1.5, 1.5                                //-- Screw hole Bottom right
                      , yappCircle, yappCenter, [yappPCBName, "PCM5102MK2"]]  //-- Screw hole Top left
 ,[pcbWidth("PCM5102MK2")-3, pcbLength("PCM5102MK2")-3, 1.5, 1.5, 1.5         //-- Screw hole Bottom left
                      , yappCircle, yappCenter, [yappPCBName, "PCM5102MK2"]]  //-- Screw hole Bottom left
];


cutoutsFront =  
[
    [(pcbWidth/2)+8, (baseWallHeight+lidWallHeight)-33, 10, 1, 1.8
                                            , yappRoundedRect, yappCenter]  //-- USB-C Cutout
  , [(pcbWidth/2)-8, (baseWallHeight+lidWallHeight)-34, 13, 1, 1.3
                                            , yappRoundedRect, yappCenter]  //-- SD Slot Cutout
];
...
cutoutsLeft =   
[//- 0,        1,   2,  3,  4, 5
    [14.0,    -7.5,  10, 10, 11/2, yappCircle, yappCenter, yappCoordPCB, [yappPCBName, "PCM5102MK2"]] //-- left Tulp
  , [48/2,    -2, 5,  5, 9/2,  yappCircle, yappCenter, yappCoordPCB, [yappPCBName, "PCM5102MK2"]] //-- Jack
  , [48-14.0, -7.5,  10, 10, 11/2, yappCircle, yappCenter, yappCoordPCB, [yappPCBName, "PCM5102MK2"]] //-- right Tulp
];
...
[
   ...
   ,[8, 5, yappFront, yappSymmetric]
   ,[30, 5, yappRight, yappSymmetric]
   ,[60, 5, yappLeft]
   ,[shellLength-30, 5, yappLeft]
];
...
{
  translate([paddingBack+34.5, paddingLeft+22, -0.4])
  {
    difference()
    {
      color("red")  cube([56,44.1,2], center=true);
      translate([-2.5,0,0]) color("blue") cube([57,40,6], center=true);
    }
    translate([-27.5,0,0]) color("black") cube([2,32,2], center=true);
  }
...
//translate([0,0,(baseWallHeight+lidWallHeight)-(basePlaneThickness+lidPlaneThickness)]) color("black") cube([4,4,4]);
//translate([160,40,(baseWallHeight+lidWallHeight)-(basePlaneThickness+lidPlaneThickness)-6]) color("black") cube([3,3,10]);
